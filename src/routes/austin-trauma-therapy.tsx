...
const FAQ = [
  ...
  },
  {
    ...
    a: "Single-incident trauma (an accident, assault, or sudden loss) often improves in 8–12 sessions. Complex or developmental trauma typically takes longer — several months of stabilization before deeper reprocessing, often a year or more of overall work.",
  },
  {
    q: "Do you offer in-person and online trauma therapy?",
    a: "Both. The Austin office is at 6448 E Hwy 290, Ste E108. Telehealth is available across Texas, and EMDR works well online with small adjustments.",
  },
  {
...
export const Route = createFileRoute("/austin-trauma-therapy")({
  head: () => ({
    meta: [
      { title: "Trauma Therapy in Austin, TX | Haven & Harbor" },
      {
        name: "description",
        content:
  ...
  component: AustinTraumaTherapyPage,
});

function AustinTraumaTherapyPage() {
  return (
    <SiteLayout>
      <PageHeader
      ...
      <section className="container-prose py-20">
        <div className="container-narrow space-y-6 text-lg leading-relaxed text-foreground/85">
          ...
          <p>
            Brittany Zientek, LPC, has 8 years of experience treating PTSD, complex trauma,
      ...
      <section className="bg-secondary/40 py-20">
        <div className="container-prose">
          ...
          <p className="mt-8 text-base text-foreground/80">
            ...
            <Link
              to="/trauma-counseling-austin"
              className="text-primary underline-offset-4 hover:underline"
            >
              trauma counseling in Austin
            </Link>{" "}
            for clients who prefer the counseling framing over therapy.
          </p>
        </div>
      </section>
      ...
      <section className="container-prose py-20">
        ...
        <p className="mt-8 text-base text-foreground/80">
          For a deeper look at how these approaches fit complex trauma, read our{" "}
          <Link
            to="/trauma-therapy-austin-guide"
            className="text-primary underline-offset-4 hover:underline"
          >
            complete guide to EMDR &amp; complex trauma therapy in Austin
          </Link>
          .
        </p>
      </section>
            ...
            {[
              {
                n: "01",
                t: "Stabilization",
                b: "Before any memory work, we build tools for nervous-system regulation and safety. No reprocessing until you're ready.",
              },
              {
                n: "02",
                t: "Reprocessing",
                b: "Using EMDR and/or IFS, we work through the memories and parts that drive current symptoms.",
              },
              {
                n: "03",
                t: "Integration",
                b: "We translate the shifts into your daily life — relationships, work, faith, body. The wins stick because they're integrated.",
              },
            ].map((s) => (
